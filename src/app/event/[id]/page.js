...
export async function generateMetadata({ params }) {
  const { id } = params;
  return {
    title: `Etkinlik - iwill`,
    description: `Bu etkinliği iwill uygulamasında görüntüle. Sosyal etkinlik paylaşım platformu.`,
    openGraph: {
      title: `Etkinlik - iwill`,
      description: `Bu etkinliği iwill uygulamasında görüntüle`,
      type: 'website',
    },
  };
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#4ECDC4] via-[#44A08D] to-[#3D8B7E] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-10 max-w-md w-full text-center border border-white/20">
        ...
        <div className="mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#4ECDC4]/20 to-[#44A08D]/20 mb-4">
            <svg className="w-8 h-8 text-[#44A08D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-gray-600 text-base">
            Bu etkinliği görmek için<br />iwill uygulamasını indirin
          </p>
        </div>
