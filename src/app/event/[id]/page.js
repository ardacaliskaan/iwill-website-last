export const metadata = {
  title: 'iwill - Etkinliği Görüntüle',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#4ECDC4] to-[#44A08D] flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Etkinliği Görüntüle</h1>
        <p className="text-gray-600 mb-8">Bu etkinliği görmek için iwill uygulamasını indir</p>
